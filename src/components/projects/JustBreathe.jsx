...
import justBreatheGif from '../../assets/just-breathe-high-fidelity-prototype.gif'
        ...
        <div className="card-content-container open">
            <ColorDiv backgroundColor={backgroundColor} className="card-content" layoutId={`card-container-${id}`} animate={{boxShadow: "-15px -5px 30px 15px rgba(0,0,0,0.25)"}}>
                ...
                >
                    ...
                    <WhiteP text="I have always been drawn to meditation but could never quite get into the habit of doing it consistently. Being able to qualm stress or anxiety, wake yourself up, or if you're lucky (and believe it’s possible) becoming more spiritually enlightened are all benefits that continue to draw millions of people towards meditation in the form of meditation guide products such as Headspace or Calm." />
                    <WhiteP text=" In this project, I sought to understand what about meditation guide products is causing myself friction, whether others feel this way too and to see what other solutions there could be." />
                    <WhiteP text=" Due to COVID-19, the project was halted in 2020 but the MVP is now being developed and will be released in 2021." />
                    ...
                    <WhiteP text="Meditation is not for everyone. I discovered that while many users were interested in the spiritual component of meditation, this was not something they were interested in attaining through a mobile app. Finally, some users were not interested in a long term commitment to medidation although they were drawn to the potential benefits." />
                    <CenteredH3 text="The Insight" />
                    <WhiteP text="Some users want the results of meditation without the spiritual component or time commitment. Many meditation techniques involve breathing techniques and mental gymnastics that are backed by modern scientific experiments to provide specific benefits such as increased concentration or relaxation. These users need a way to easily learn and do these techniques." />
                    ...
                    <CenteredImage alt="just-breathe-high-fidelity-prototype" src={justBreatheGif} />
                    <CenteredH3 text="Next steps!" />
                    <WhiteP text="Launch of the first public build is planned for early 2021 using Apple's new declarative framework SwiftUI!" />
                </motion.div>
            </ColorDiv>
        </div>
        </div>
